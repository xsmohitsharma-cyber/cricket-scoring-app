{
  ...
  "ContextMenu": {
    ...
    "desc": "Displays a menu to the user â such as a set of actions or functions â triggered by a button.",
    "exports": [
      "ContextMenu",
      "ContextMenuTrigger",
      "ContextMenuContent",
  ...
  "RadioGroup": {
    ...
    "desc": "A set of checkable buttonsâknown as radio buttonsâwhere no more than one of the buttons can be checked at a time.",
  ...
  "Tabs": {
    ...
    "desc": "A set of layered sections of contentâknown as tab panelsâthat are displayed one at a time.",
